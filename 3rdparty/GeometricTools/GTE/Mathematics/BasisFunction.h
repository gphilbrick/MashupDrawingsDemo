...
namespace gte
{
    ...
    public:
        ...
        // WARXING: Greg Philbrick change
        // I am adding ability to copy 'BasisFunction' in order to make my wrapping spline class
        // more efficient to clone.
        BasisFunction( BasisFunction const& other )
        {
            *this = other;
        }
        BasisFunction& operator=( BasisFunction const& other )
        {
            mNumControls = other.mNumControls;
            mDegree = other.mDegree;
            mTMin = other.mTMin;
            mTMax = other.mTMax;
            mTLength = other.mTLength;
            mOpen = other.mOpen;
            mUniform = other.mUniform;
            mPeriodic = other.mPeriodic;
            mUniqueKnots = other.mUniqueKnots;
            mKnots = other.mKnots;
            mKeys = other.mKeys;
            initMJet(); // Assuming 'mJet' is the reason copying was initially forbidden.
            return *this;
        }
